...
rooms:
  - name: 모더레이트 패밀리 로프트
    ...
    recommended: true
    note: 성인 3인은 싱글만 써도 됩니다. 퀸+소파 타입은 고르지 마세요.
  - name: 슈퍼리어 유니버설 트윈
    size_sqm: 40
    beds: 더블 2
    capacity_official: 4
    ...
    recommended: true
    note: 부부+자녀가 더블을 나눠 쓰기 쉽고, 욕조가 있는 타입입니다.
---

공식 안내 기준 우에노역·오카치마치역 도보 5분, 히비야선 나카오카치마치 3분입니다. 객실 8타입, 35~50㎡, 전 객실 키친·세면 분리. 최대 8인 타입까지 있어 3인이 쓰면 짐과 세탁이 남습니다. 디럭스 패밀리 로프트 50㎡는 아이 둘까지 가는 일정용이지, 3인에게는 과할 수 있습니다.
